...
// 1. استخدام المكتبة المتوافقة تماماً مع السيرفر بدون مشاكل بناء
const bcrypt = require('bcryptjs'); 

// 2. تحديد مسار ثابت ومطلق لملف قاعدة البيانات لضمان صلاحيات القراءة والكتابة
...
db.serialize(() => {
    ...
    settingsList.forEach(s => db.run(`INSERT OR IGNORE INTO settings (key, value) VALUES (?, ?)`, s));
